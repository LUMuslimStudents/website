        ...
        items: [
          {
            ...
            icon: MapPin,
            description:
              "Practical guides to help you settle into student life in Lund.",
          },
          {
            label: "Halal map",
        ...
        items: [
          {
            ...
            icon: FaWhatsapp,
            description:
              "Join our community chats to stay in the loop day to day.",
            external: true,
          },
          {
...
/** Flatten every internal item so we can compute the active category from the URL. */
